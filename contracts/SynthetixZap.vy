...
def __init__(
    ...
    @param _seth Address of the sETH token
    @param _curve_pool Address of the ETH/sETH Curve pool
    @param _token_index Index of sETH token in Curve pool (0 or 1)
    @param _lp_token Address of ETH/sETH Curve pool LP token
    @param _booster Address of the Convex Booster contract (0 for optimism)
    """
